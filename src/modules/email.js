        ...
        <div className="about-container">
          <form onSubmit={this.handleSubmit.bind(this)}>
            <div className="contain-input">
              <label className="email" htmlFor="text-input">
                Email:
              </label>
              <input
                type="email"
              ...
              />
              <label className="name" htmlFor="text-input">
                Name:
              </label>
              <input
                type="text"
                ...
                placeholder="Name"
              />
              <label className="subject" htmlFor="text-input">
                Subject:
              </label>
              <input
                type="text"
                ...
                placeholder="Subject"
              />
              <label className="message" htmlFor="textarea">
                Message:
              </label>
              <textarea
                type="textarea"
